...
def main():
    ...
    name = "Eshaan" # TODO: Insert your name between the double quotes

    print(f"{name}, Welcome to the CSS course!")
    print("Hi, I'm Eshaan. I'm a junior from Cypress, Texas, but I go to boarding school in New Hampshire.")
